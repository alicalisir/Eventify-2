...
@override
int get hashCode => Object.hash(runtimeType,id,title,description,rationale,category,distance,estimatedMinutes,address,latitude,longitude,const DeepCollectionEquality().hash(tags),eventId,weather,createdAt);

@override
String toString() {
  return 'SuggestionModel(id: $id, title: $title, description: $description, rationale: $rationale, category: $category, distance: $distance, estimatedMinutes: $estimatedMinutes, address: $address, latitude: $latitude, longitude: $longitude, tags: $tags, eventId: $eventId, weather: $weather, createdAt: $createdAt)';
}
...
@useResult
$Res call({
 String id, String title, String description, String rationale, String category, double? distance, int? estimatedMinutes, String? address, double? latitude, double? longitude, List<String> tags, String? eventId, String? weather, DateTime createdAt
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String title,  String description,  String rationale,  String category,  double? distance,  int? estimatedMinutes,  String? address,  double? latitude,  double? longitude,  List<String> tags,  String? eventId,  String? weather,  DateTime createdAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SuggestionModel() when $default != null:
return $default(_that.id,_that.title,_that.description,_that.rationale,_that.category,_that.distance,_that.estimatedMinutes,_that.address,_that.latitude,_that.longitude,_that.tags,_that.eventId,_that.weather,_that.createdAt);case _:
  return orElse();
...
@override
int get hashCode => Object.hash(runtimeType,id,title,description,rationale,category,distance,estimatedMinutes,address,latitude,longitude,const DeepCollectionEquality().hash(_tags),eventId,weather,createdAt);
